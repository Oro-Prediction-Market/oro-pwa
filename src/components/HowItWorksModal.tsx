...
const STEPS: Step[] = [
  {
    icon: <User size={32} />,
    title: "Open the app",
    desc: "Use Oro in Telegram or on the web at oro.fun — same account either way. Telegram signs you in automatically; no sign-up form.",
  },
  {
    icon: <Building2 size={32} />,
    title: "Link DK Bank, or use USDT",
    desc: "Link DK Bank with your 11-digit CID for instant ngultrum deposits and withdrawals. Prefer crypto? Verify your ID once and use USDT from your own wallet. The two balances stay separate — never converted.",
  },
  {
    icon: <Lock size={32} />,
  ...
  },
  {
    ...
    desc: "Deposit from DK Bank and your credits land instantly. USDT: send to the address the app shows — it credits once the network confirms.",
  },
  {
    icon: <Target size={32} />,
    title: "Pick a market & predict",
    desc: 'Browse the Feed, choose an outcome (e.g. "X Team wins"), and enter your amount. Your prediction is placed immediately.',
  },
  {
