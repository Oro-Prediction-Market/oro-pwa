    ...
    >
      ...
      <div
        style={{
          ...
          animation:
            "modalSlideUp 0.3s cubic-bezier(0.34,1.56,0.64,1) forwards",
        }}
      >
        {/* ── Result screens ──────────────────────────────────────────────── */}
        {status === "success" && (
          <div style={{ textAlign: "center", padding: "32px 0 24px" }}>
            <div
              style={{
                ...
                marginBottom: 16,
                animation:
                  "successPop 0.55s cubic-bezier(0.34,1.56,0.64,1) forwards, successGlow 1.2s ease 0.55s 2",
              }}
            >
              <svg
                width="38"
            ...
            <div
              style={{
                ...
                color: "#16a34a",
                marginBottom: 6,
                animation: "fadeSlideIn 0.35s ease 0.3s both",
              }}
            >
              Position Opened!
            </div>
            <div
              style={{
                ...
                animation: "fadeSlideIn 0.35s ease 0.45s both",
              }}
            >
          ...
          <div style={{ textAlign: "center", padding: "32px 0 24px" }}>
            <div
              style={{
                ...
                marginBottom: 16,
                animation:
                  "failShake 0.55s cubic-bezier(0.36,0.07,0.19,0.97) forwards",
              }}
            >
              <svg
                width="36"
