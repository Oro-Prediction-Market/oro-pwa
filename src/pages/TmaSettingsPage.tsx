...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Go to Wallet → Enter your 11-digit CID. This links your real bank account so you can deposit and withdraw BTN. Prefer crypto? Verify your identity once and fund a separate USDT wallet from your own crypto wallet instead — the two balances are never converted into each other.",
  },
  {
    emoji: <Coins />,
    title: "Add funds to your wallet",
    desc: "Tap Wallet → Deposit and pay via DK Bank. Your Oro credits top up instantly. Minimum deposit is Nu 50. For USDT, use the Deposit tab in your USDT wallet and send to the address shown — it credits once the network confirms it.",
  },
  {
    emoji: <Target />,
