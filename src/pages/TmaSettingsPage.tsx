...
const STEPS = [
  ...
  },
  {
    ...
    desc: "Wallet → enter your 11-digit CID to link your bank for BTN. Prefer crypto? Verify your ID once and use a separate USDT wallet — the two never convert.",
  },
  {
    emoji: <Coins />,
    title: "Add funds to your wallet",
    desc: "Wallet → Deposit, pay via DK Bank; credits land instantly (min Nu 50). USDT: send to the address shown — credits once the network confirms.",
  },
  {
    emoji: <Target />,
