...
import { StreakBenefitsModal } from "@shared/components/StreakBenefitsModal";
import { ProfileShareCard } from "@shared/components/ProfileShareCard";
import { LoadingScreen } from "@shared/components/LoadingScreen";
import {
  BadgeGrid,
  buildBadges,
  type CollectibleBadge,
} from "@shared/components/BadgeGrid";
import {
  Trophy,
  Flame,
  Swords,
...
export const TmaProfilePage: FC = () => {
  ...
  const toggleFeatured = async (id: string) => {
    ...
    if (next === featuredIds) return;
    setFeaturedIds(next);
    try { await setFeaturedAchievements(next); } catch { setFeaturedIds(featuredIds); }
  };
