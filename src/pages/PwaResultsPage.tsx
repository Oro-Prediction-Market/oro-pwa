...
export function PwaResultsPage() {
  ...
  const isUnauthed =
    betsError != null &&
    (betsError.toLowerCase().includes("unauthorized") ||
      betsError.toLowerCase().includes("401") ||
      betsError.toLowerCase().includes("sign in"));
  ...
  return (
    ...
    >
      ...
      {/* ── Personal stats / unauthenticated gate ── */}
      {betsLoading ? (
        <div
          style={{
            textAlign: "center",
        ...
        >
          ...
          >
            Your win rate, prediction history, and tier are all here once you're
            signed in.
          </div>
        </div>
      ) : (
