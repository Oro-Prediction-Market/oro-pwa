 ...
 * only use:
 *   - useAuth() from @/hooks/useAuth  → calls getToken()/getMe() which work in PWA
 *   - <Page> from @/components/Page   → uses TMA backButton (crashes in PWA)
 *
...
export { TmaLeaderboardPage as PwaLeaderboardPage } from "@/pages/TmaLeaderboardPage";
export { TmaChallengesPage as PwaChallengesPage } from "@/pages/TmaChallengesPage";
export { TmaProfilePage as PwaProfilePage } from "@/pages/TmaProfilePage";
export { TmaWalletPage as PwaWalletPageFull } from "@/pages/TmaWalletPage";
