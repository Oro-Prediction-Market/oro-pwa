            ...
            <div style={{ display: "flex", gap: 8, marginBottom: 4 }}>
              {(
                [
                  ...
                  // No count until they are fetched — "Previous (0)" mid-season
              ...
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12, minWidth: 460 }}>
                ...
                <tbody>
                  {standingsRows.map((row, i) => {
                    // Zone stripe: top 4 UCL (green), 5th UEL (amber), bottom 3
                    // relegation (pink).
                    //
                    // Counted by ROW, not by the position number. The feed
                    // gives tied clubs the same position and then skips the
                    // next one — early season it reads …15, 16, 17, 17, 19, 20
                    // — so there is no 18th position at all, and "pos >= 18"
                    // striped only two clubs.
                    const stripe =
                      i < 4
                        ? ACCENT
                        : i === 4
