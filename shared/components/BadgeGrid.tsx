...
import { tierAtLeast } from "../reputation/tiers";
...
import imgEplSeason from "../assets/collectibles/eventbadges/premierleague-2026-27.png";
import imgUclSeason from "../assets/collectibles/eventbadges/championsleague-2026-27.png";
// Monthly leaderboard podium
import imgMonthlyChampion from "../assets/collectibles/monthlypodiumbadges/monthly-champion.png";
import imgMonthlyRunnerUp from "../assets/collectibles/monthlypodiumbadges/monthly-runner-up.png";
import imgMonthlyThird from "../assets/collectibles/monthlypodiumbadges/monthly-third.png";
      ...
      >
        {badges.map((b) => (
          <div
            ...
            onClick={(e) => {
              e.stopPropagation();
              if (b.unlocked && onToggleFeatured) onToggleFeatured(b.id);
              else setTapped((prev) => (prev === b.id ? null : b.id));
            }}
            style={{
              display: "flex",
          ...
          >
                ...
                background: b.legendary
                  ...
                  : b.unlocked
                    ? b.tint && !b.img
                      ...
                      : "var(--bg-secondary)"
                    : "var(--bg-secondary)",
                border: featuredIds.includes(b.id)
                  ? "2px solid #fbbf24"
                  : b.legendary
                  ? b.unlocked
                    ? "2px solid #ffd700"
            ...
            >
              ...
              {featuredIds.includes(b.id) && (
                <span style={{ position: "absolute", right: 2, bottom: 2, width: 15, height: 15, borderRadius: "50%", background: "#fbbf24", color: "#111827", fontSize: 11, fontWeight: 900, lineHeight: "15px", textAlign: "center", boxShadow: "0 1px 4px rgba(0,0,0,.5)" }}>✓</span>
              )}
              {b.unlocked && (b.count ?? 0) > 1 && (
                <span style={{ position: "absolute", right: 1, top: 1, minWidth: 15, height: 15, padding: "0 3px", borderRadius: 8, background: "#111827", color: "#fbbf24", fontSize: 10, fontWeight: 900, lineHeight: "15px", textAlign: "center", boxShadow: "0 1px 4px rgba(0,0,0,.5)" }}>×{b.count}</span>
              )}
            </div>
